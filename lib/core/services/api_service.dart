...
final List<Map<String, dynamic>> _mockQuestions = [
  ...
  {"id": "q_022", "text": "In a sequence, each figure rotates 45\u00B0 clockwise and alternates filled/hollow. What is the 5th figure if the 1st is a filled square at 0\u00B0?", "options": [{"id": "q_022_a", "text": "Filled square at 180\u00B0"}, {"id": "q_022_b", "text": "Hollow square at 180\u00B0"}, {"id": "q_022_c", "text": "Filled square at 135\u00B0"}, {"id": "q_022_d", "text": "Hollow square at 135\u00B0"}], "subject": "Abstract Reasoning"},
  ...
  {"id": "q_026", "text": "If A \u2192 B means 'A is smaller than B', and the sequence shows: small circle \u2192 medium circle \u2192 ? \u2192 large square. What fills the gap?", "options": [{"id": "q_026_a", "text": "Large circle"}, {"id": "q_026_b", "text": "Medium square"}, {"id": "q_026_c", "text": "Small square"}, {"id": "q_026_d", "text": "Large triangle"}], "subject": "Abstract Reasoning"},
